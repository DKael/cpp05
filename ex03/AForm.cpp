...
int AForm::getIsSigned() const { return isSigned; }
...
AForm::GradeException::GradeException(const char* who,
...
const char* AForm::GradeException::what() const throw() { return message; }
